...
class DescribeRankingTableRequest(Gs2BasicRequest):

    class Constant(Gs2Ranking):
        FUNCTION = "DescribeRankingTable"
    ...
    def __init__(self, params=None):
        ...
        """
        super(DescribeRankingTableRequest, self).__init__(params)
        if params is None:
    ...
    def with_page_token(self, page_token):
        ...
        :type page_token: unicode
        :return: this
        :rtype: DescribeRankingTableRequest
        """
