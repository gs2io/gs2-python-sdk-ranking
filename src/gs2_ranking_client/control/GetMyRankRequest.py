...
class GetMyRankRequest(Gs2UserRequest):
    ...
    def __init__(self, params=None):
        ...
        """
        super(GetMyRankRequest, self).__init__(params)
        if params is None:
    ...
    def set_ranking_table_name(self, ranking_table_name):
        ...
        """
        if _ranking_table_name and not (isinstance(_ranking_table_name, str) or isinstance(_ranking_table_name, unicode)):
    ...
    def set_game_mode(self, game_mode):
        ...
        """
        if _game_mode and not (isinstance(_game_mode, str) or isinstance(_game_mode, unicode)):
